...
class InstaBot:
    ...
    def generate_comment(self):
        c_list = list(itertools.product(
                                    ["this", "The", "Your"],
                                    ["moment","photo", "picture", "pic", "shot", "snap"],
                                    ["is", "looks", "feels", "is really"],
                                    ["great", "super", "good", "very good",
                                    "good", "wow", "cool", "Great", "magnificent", "magical", "very cool",
                                    "stylish", "beautiful", "so peaceful", "so stylish", "so professional",
                                    "lovely", "so lovely", "very lovely", "glorious", "adorable", "excellent", "amazing"],
                                    [".", "..", "...", "!", "!!", "!!!"]))
